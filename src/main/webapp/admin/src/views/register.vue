    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">社区疫情通知通告系统注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="住户姓名" class="input" v-if="tableName=='zhuhu'">
                            <el-input v-model="ruleForm.zhuhuName" autocomplete="off" placeholder="住户姓名"  />
                        </el-form-item>
                        <el-form-item label="住户手机号" class="input" v-if="tableName=='zhuhu'">
                            <el-input v-model="ruleForm.zhuhuPhone" autocomplete="off" placeholder="住户手机号"  />
                        </el-form-item>
                        <el-form-item label="住户身份证号" class="input" v-if="tableName=='zhuhu'">
                            <el-input v-model="ruleForm.zhuhuIdNumber" autocomplete="off" placeholder="住户身份证号"  />
                        </el-form-item>
        ...
        methods: {
            ...
            login() {
                            ...
                            if(this.ruleForm.repetitionPassword != this.ruleForm.password){
                             ...
                             if('zhuhu' == this.tableName && this.ruleForm.zhuhuPhone&&(!this.$validate.isMobile(this.ruleForm.zhuhuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.zhuhuIdNumber)&& 'zhuhu'==this.tableName){
