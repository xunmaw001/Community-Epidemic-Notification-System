...
public class ShequchuruView extends ShequchuruEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 出入类型的值
		*/
		private String shequchuruValue;
	...
	public ShequchuruView() {

	}

	public ShequchuruView(ShequchuruEntity shequchuruEntity) {
		try {
			BeanUtils.copyProperties(this, shequchuruEntity);
			...
			* 获取： 出入类型的值
			*/
			public String getShequchuruValue() {
				return shequchuruValue;
			}
			/**
			* 设置： 出入类型的值
			*/
			public void setShequchuruValue(String shequchuruValue) {
				this.shequchuruValue = shequchuruValue;
			}
