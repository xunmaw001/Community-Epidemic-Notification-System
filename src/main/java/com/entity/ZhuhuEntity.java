...
public class ZhuhuEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Zhuhu{" +
            ...
            ", zhuhuIdNumber=" + zhuhuIdNumber +
            ", zhuhuAddress=" + zhuhuAddress +
            ", zhuhuPhoto=" + zhuhuPhoto +
            ", zhuhuAge=" + zhuhuAge +
            ", sexTypes=" + sexTypes +
            ", zhuhuYimiaoTypes=" + zhuhuYimiaoTypes +
            ", zhuhuLaiyuandi=" + zhuhuLaiyuandi +
            ", zhuhuHesuanTypes=" + zhuhuHesuanTypes +
            ", zhuhuXingcheng=" + zhuhuXingcheng +
            ", zhuhuContent=" + zhuhuContent +
            ", zhuhuTypes=" + zhuhuTypes +
            ", zhuhuTime=" + zhuhuTime +
